            ...
            <div class="flex flex-col md:flex-row items-center gap-8">
                ...
                <div class="relative group">
                    <div class="w-32 h-32 rounded-full overflow-hidden border-4 border-indigo-50 shadow-md">
                        ...
                        @else
                            <div
                                class="w-full h-full bg-indigo-100 flex items-center justify-center text-indigo-500 text-4xl font-bold uppercase">
                ...
                <div class="flex-shrink-0">
                    <a href="{{ route('doctor.bookings.index') }}"
                        class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-indigo-600 hover:bg-indigo-700 shadow-sm transition-all hover:shadow-md">
                        {{ __('View Schedule') }}
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span
                        class="text-xs font-semibold text-green-600 bg-green-50 px-2 py-1 rounded-full">{{ __('Active') }}</span>
                </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                ...
                <h3 class="text-3xl font-bold text-slate-800 mb-1">${{ Auth::user()->doctorProfile->session_price ?? 0 }}
                </h3>
